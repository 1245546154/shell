...
<html lang="en">
  ...
  <meta property="fb:app_id" content="1401488693436528">
    ...
    <meta property="og:image" content="https://avatars2.githubusercontent.com/u/1475030?s=400&amp;v=4" /><meta property="og:site_name" content="GitHub" /><meta property="og:type" content="object" /><meta property="og:title" content="teddysun/across" /><meta property="og:url" content="https://github.com/teddysun/across" /><meta property="og:description" content="across - Across the Great Wall we can reach every corner in the world" />

  <link rel="assets" href="https://assets-cdn.github.com/">
  
  <meta name="pjax-timeout" content="1000">
  
  <meta name="request-id" content="90A4:1155:323E3C:47C0E2:5B751D28" data-pjax-transient>
...
<meta class="js-ga-set" name="dimension1" content="Logged Out">
    ...
    <meta name="js-proxy-site-detection-payload" content="ZWQ1ZThlYjI0ZjI0NTRkNTI1ZDA0MDcxNWY5MDMyYTdhZmEwNGNhMzY4Y2NmZWNmNGRiNzYxOTU4M2ExMmQ1OXx7InJlbW90ZV9hZGRyZXNzIjoiNDcuNzQuMjI0LjkzIiwicmVxdWVzdF9pZCI6IjkwQTQ6MTE1NTozMjNFM0M6NDdDMEUyOjVCNzUxRDI4IiwidGltZXN0YW1wIjoxNTM0NDAxODMzLCJob3N0IjoiZ2l0aHViLmNvbSJ9">
  ...
  <meta name="html-safe-nonce" content="bfd3c3aa75374503f1972afa59d9b813211b01c6">
...
>
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" data-scope-type="Repository" data-scope-id="32967073" data-scoped-search-url="/teddysun/across/search" data-unscoped-search-url="/search" action="/teddysun/across/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
      <label class="form-control header-search-wrapper header-search-wrapper-jump-to position-relative d-flex flex-justify-between flex-items-center js-chromeless-input-container">
        <input type="text"
          ...
          data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations#csrf-token=KoRTtNFKIi0cnGe0UdYdoYQ5Zeqh1fPuLGTKD12ch2vfh7jQAIDiP3J8nhhJm2X3uWq9mdaecKLED6NjbS9jUQ=="
          spellcheck="false"
          autocomplete="off"
          >
          ...
          <span class="d-inline-block">
              <div class="HeaderNavlink px-0 py-2 m-0">
                <a class="text-bold text-white no-underline" href="/login?return_to=%2Fteddysun%2Facross%2Fblob%2Fmaster%2Fbench.sh" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in; experiment:site_header_dropdowns; group:control">Sign in</a>
  ...
  <li>
    ...
    <a class="social-count js-social-count" href="/teddysun/across/stargazers"
      aria-label="1183 users starred this repository">
      1,183
    </a>
  ...
  <li>
    ...
    <a href="/teddysun/across/network/members" class="social-count"
       aria-label="735 users forked this repository">
      735
    </a>
  </li>
</ul>
...
<nav class="reponav js-repo-nav js-sidenav-container-pjax container"
  ...
  <a class="js-selected-navigation-item reponav-item" data-selected-links="repo_graphs repo_contributors dependency_graph pulse /teddysun/across/pulse" href="/teddysun/across/pulse">
...
<div class="container new-discussion-timeline experiment-repo-nav  ">
  ...
  <!-- blob contrib key: blob_contributors:v21:daf4fbf66decd4d2bbc37d0f9052ac20 -->
      ...
      <div class="signup-prompt p-4 text-center mb-4 rounded-1">
        <div class="position-relative">
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form action="/site/dismiss_signup_prompt" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="IbQoBZTiVLIndstpR5Ztvfsvyfqw2IzxzVWIKlVBQJmx0TaTXxgw11RL5KoEy6CH9navHcZQ4vy1Ub6EsHuvqg==" />
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between pt-6 pb-2 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2018 <span title="0.12281s from unicorn-b445bb8cf-ms7z4">GitHub</span>, Inc.</li>
